		...
		if (check_username != null) {
			...
			try {
				if (csrfTokenFromRequest != null && csrfTokenFromRequest.equals(csrfTokenFromSession)) {
					...
					String lan0_ipaddr = new JSONObject(respStr).getString("eth1_ipaddr");
					String lan0_subnet = new JSONObject(respStr).getString("eth1_subnet");
					String status = new JSONObject(respStr).getString("status");
					String eth0_dhcp = new JSONObject(respStr).getString("eth1_dhcp");
					...
					jsonObject.put("eth1_dhcp", eth0_dhcp);
