...
@WebServlet("/trafficRulesServletLan1")
public class TrafficRulesServletLan1 extends HttpServlet {
	final static Logger logger = Logger.getLogger(TrafficRulesServletLan1.class);
...
protected void doPost(HttpServletRequest request, HttpServletResponse response)
	...
	if (check_username != null) {
		...
		String operation_action = request.getParameter("operation_action_lan1");
