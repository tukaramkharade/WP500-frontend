...
<body>
    ...
    <div id="loader">
        ...
        <p>Loading...</p>
				...
				<td>Interval</td>
				<td><select class="json-interval-select" id="json_interval" name="json_interval" style="height: 35px;" required>					
				...
				<td>Broker type</td>
				<td><select class="textBox" id="broker_type" name="broker_type" style="height: 35px;" required>						
							<option value="mqtt" selected>mqtt</option>
							<option value="iothub">iothub</option>
						</select> </td>					
				<td>Broker IP address</td>
				<td><select class="textBox" id="broker_name" name="broker_name" style="height: 35px;" required>
					...
					<td><select class="textBox" id="publishing_status" name="publishing_status" style="height: 35px;" required>
							<option value="Enable" selected>Enable</option>
							<option value="Disable">Disable</option>
						</select> </td>			
				<td>Store and forward</td>
				<td><select class="textBox" id="storeAndForward" name="storeAndForward" style="height: 35px;" required>							
							<option value="Enable" selected>Enable</option>
							<option value="Disable">Disable</option>
						</select> </td>
						<td></td>
				...
				<tr>				
				<td colspan="8"  style="text-align: center;"><input style="margin-top: 1%;" type="button" value="Validate" id="validateBtn" /></td>			
				</tr>		
				<tr>
